    ...
    <div className="min-h-screen bg-background text-on-background">
      <header className="sticky top-0 z-30 border-b border-outline-variant bg-background/95 backdrop-blur-md">
        <div className="max-w-2xl mx-auto px-4 py-2.5 flex items-center gap-3">
          ...
          <h1 className="text-sm font-display font-bold text-on-surface flex-1">Meu Perfil</h1>
          <button
            onClick={() => navigate('/meus-pedidos')}
            className="flex items-center gap-1.5 text-xs font-semibold text-on-surface-variant hover:text-primary transition-colors px-2 py-1.5 rounded-lg hover:bg-surface-container"
          >
